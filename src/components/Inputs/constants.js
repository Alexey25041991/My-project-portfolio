...
export const SUFFIX_PADDING_BIG = 18;
export const SUFFIX_PADDING_SMALL = 10;
export const SUFFIX_PADDING_MICRO = 7;
...
export const COINS_PADDING_BIG = 16;
export const COINS_PADDING_SMALL = 8;
export const COINS_PADDING_MICRO = 5;
export const COINS_WIDTH_DEFAULT = 22;
export const COINS_WIDTH_MICRO = 20;
export const ICON_PADDING_TOP_BIG = 26;
export const ICON_PADDING_TOP_SMALL = 16;
export const ICON_PADDING_TOP_MICRO = 5;
export const INCREMENT = 'increment';
export const DECREMENT = 'decrement';
export const DEFAULT_MAX_INPUT_LENGTH = 16;
export const ICON_WRAPPER_HEIGHT_MICRO = 20;
export const ICON_WRAPPER_DEFAULT = 24;
